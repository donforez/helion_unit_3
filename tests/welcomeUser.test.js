...
describe('Sprawdzanie poprawności powitań', () => {
    test('Po podaniu wszystkich poprawnych danych, zwróci powitanie w poprawnym formacie', () => {
        ...
        const validAnswer = 'Witaj Jan Kowalski! Czy dobrze pamiętam, że masz 100 lat i mieszkasz w Sosnowiec? Dobrze Cię znowu widzieć!'
    ...
    test('Kiedy zostanie podana część właściwości, zwróci powitanie z częściowo domyślnymi wartościami', () => {
        const validAnswer = 'Witaj John Kowalski! Czy dobrze pamiętam, że masz 30 lat i mieszkasz w Sosnowiec? Dobrze Cię znowu widzieć!'
